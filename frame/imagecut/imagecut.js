/*
 ...
 名称 	说明
 setImage(string) 	设定（或改变）图像。例：imagecut.setImage("newpic.jpg")
 ...
 enable() 	启用 Jcrop
 destroy() 	移除 Jcrop
 tellSelect() 	获取选框的值（实际尺寸）。[x,y,x2,y2]
...
define(function(){
    ...
    var imagecut = function (obj, opt) {
        var options = $.extend({}, imagecut.defaults),
            docOffset,
    ...
    imagecut.Loader = function(imgobj,success,error){
